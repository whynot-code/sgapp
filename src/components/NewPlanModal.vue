...
export default {
    ...
    computed: {
        ...mapGetters(["newPlan", "currOrders"]),
        nextId() {
            return this.currContacts[0].id
        },
        orders() {
            return this.currOrders ? this.currOrders : null
        }
    },
    methods: {
